...
class Consequence(models.Model):
    ...
    def html_form(self):
        ...
        output = "<form class='form-inline'><label class='control-label'>" + str(self.name) + "</label> "
        output += "<input type='text' class='form-control input-sm' placeholder='" + placeholder + "' /></form>"
        return output
